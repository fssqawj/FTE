...
ipython myMain_FOAF.py -- --latent 10 --lmbda 0 --train myData/FOAF/myTrain.txt  --test myData/FOAF/myTest.txt --log test.log --result test.log --spath exp/FOAF_embedding_
