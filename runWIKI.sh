...
ipython myMain_WIKI.py -- --latent 10 --lmbda 0 --train myData/WIKI/ZZLtrain.txt  --test myData/WIKI/ZZLtest_1000.txt --log test.log --result test.log --spath exp/WIKI_embedding_
