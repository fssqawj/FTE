...
if __name__ == '__main__':
    ...
    runRescal.RunTransE("myData/WN18/entity2id.txt", "myData/WN18/relation2id.txt", "myData/WN18/entity2vec.bern", "myData/WN18/relation2vec.bern")
